  ...
  module Invoice
    def define_columns
      return Proc.new do
        ...
        column :is_finance_charge, :boolean
        ...
        column :applied_amount, :decimal, :precision => 9, :scale => 2
        column :balance_remaining, :decimal, :precision => 9, :scale => 2
        ...
        column :suggested_discount_amount, :decimal, :precision => 9, :scale => 2
        column :suggested_discount_date, :datetime
